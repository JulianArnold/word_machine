20180407: setup routes and framework for new user sign_up.  links on home page to be done.

20180402: Would have been flummoxed re: assert_equal full_title test.  Found via google, it is the actual string you
see in the title tab: 'Word Machine Blog'. Add ("Help") plus '|' to complete the picture.  Schedule a day to learn
about testing: http://guides.rubyonrails.org/testing.html

20180401: fixed it (not an April fool's) by including both footer and header partials.  Completed the remaining
exercise including the application test into test_helper, then created a new file testing for the actual titles.

20180331: this exercise: "In the footer partial, change about_path to contact_path and verify that the tests catch
the error." Doesn't catch the error..(?)
...
20180325: exercise here: "It’s possible to use a named route other than the default using the as: option. Drawing inspiration from this famous Far Side comic strip, change the route for the Help page to use helf (Listing 5.29)." didn't yield 'green'
